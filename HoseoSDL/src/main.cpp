...
#ifdef UNICODE
    SDL_Surface* temp_surf = TTF_RenderUNICODE_Shaded(m_pFont, (Uint16*)L"야호~~~~", color_Blue, color_White);
#else
    SDL_Surface* temp_surf = TTF_RenderUTF8_Shaded(m_pFont, "야호~~~~", color_Blue, color_White);
#endif
		if (temp_surf == 0) {	
